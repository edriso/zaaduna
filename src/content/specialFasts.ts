 ...
 *     • gives the date as an approximation, labelled «الحساب الفلكي (تقويم
 *       أمّ القرى)» — plain "astronomical calculation" wording so a lay reader
 *       gets it, with the Umm al-Qura name kept in parentheses for precision —
 *       NOT the old coined «بتوقيت القناة» that few understood, and
 ...
 *     استحباب صيام تاسوعاء مع عاشوراء، مخالفةً لأهل الكتاب.
...
والسنّة أن تصوم معه يومًا قبله (تاسوعاء، التاسع)؛ قال ﷺ: «لئن بقيتُ إلى قابلٍ لأصومنّ التاسع» (رواه مسلم)، مخالفةً لليهود.

🗓️ هذه المواعيد على وجه التقريب، حسب الحساب الفلكي (تقويم أمّ القرى): تاسوعاء يوم ٩ محرّم، وعاشوراء يوم ١٠. وقد يتقدّم اليوم أو يتأخّر يومًا واحدًا بين بلدٍ وآخر بحسب رؤية الهلال، فاعتمِد إعلانَ بلدك أنت.

✅ والسنّة الثابتة أن تصوم التاسع والعاشر معًا، والأكملُ أن تضمّ إليهما الحادي عشر. وهذا أحوطُ أيضًا إن لم تتيقّن من بداية الشهر عندك، حتى تُدركَ العاشرَ بيقين (وأرشد إليه الإمام أحمد عند اشتباه أوّل الشهر).
...
🗓️ هذه المواعيد على وجه التقريب، حسب الحساب الفلكي (تقويم أمّ القرى): عرفةُ يوم ٩ ذي الحجة، ثم عيدُ الأضحى يوم ١٠ (ولا صيام في يوم العيد). وقد يتقدّم اليوم أو يتأخّر يومًا واحدًا بين بلدٍ وآخر بحسب رؤية الهلال، فاعتمِد إعلانَ بلدك في تحديد عرفةَ والعيد.
...
🗓️ تبدأ غدًا بإذن الله (١٣ من الشهر حسب الحساب الفلكي). وقد يختلف أوّل الشهر يومًا واحدًا بين بلدٍ وآخر، فاعتمِد تقويمَ بلدك.
